...
const missingAgentInstallTestIds = [
  ...
  'ai-agents-onboarding-install-hermes',
] as const
const installLinkTargets = [
  ...
  ['ai-agents-onboarding-install-kiro', 'https://www.kiro.dev'],
  ['ai-agents-onboarding-install-hermes', 'https://hermes-agent.nousresearch.com/docs'],
] as const
